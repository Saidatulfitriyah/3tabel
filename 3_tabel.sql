...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 25 Jan 2023 pada 08.57
...
(1, '2022-12-12', 2000000),
(2, '2022-12-25', 3000000);
...
--
ALTER TABLE `tb_siswa`
  ADD CONSTRAINT `tb_siswa_ibfk_1` FOREIGN KEY (`id_spp`) REFERENCES `tb_spp` (`id_spp`) ON DELETE CASCADE ON UPDATE CASCADE,
